...
public class VegeFragment extends Fragment {
     ...
     * @return A new instance of fragment VegeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static VegeFragment newInstance(String param1, String param2) {
        VegeFragment fragment = new VegeFragment();
    ...
    private void fetchmeals() {
        db.collection("meals")
                .whereArrayContains("tags", "Vegetarian") // or "Vegan"
